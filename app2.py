...
def hr_reg():
    if request.method == 'POST':
        ...
        try:
            ...
            try:
                sql1 = "INSERT INTO company_details (company_id, company_rep, company_name, website, type_of_org, industry_sector) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
            ...
            try:
                ...
                return render_template('login/company_rep.html', value=error)
            try:
                sql1 = "INSERT INTO hr_invited (hr_email, company_name) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
                values1 = (hr_email, company_name)
                cur.execute(sql1, values1)
                mysql.connection.commit() 
